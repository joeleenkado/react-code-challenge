      ...
      <>
        ...
        <div style={{ padding: 20 }}>
          ...
          <input
            ...
            onChange={(e) =>
              this.setState({
                newProject: { ...newProject, id: e.target.value },
              })
            }
          />
          <br />
          ...
          <input
            ...
            onChange={(e) =>
              this.setState({
                newProject: { ...newProject, projectName: e.target.value },
              })
            }
          />
          <br />
          ...
          <select
            name="active"
            id="active"
            value={newProject.isActive}
            onChange={(e) =>
              this.setState({
                newProject: { ...newProject, isActive: e.target.value },
              })
            }
          >
